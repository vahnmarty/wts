        ...
        <div class="space-y-1 pb-8">
            ...
            <a href="#" aria-current="page"
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                    aria-hidden="true" class="-ml-1 mr-3 size-6 shrink-0 text-gray-500">
                    <path
            ...
            <a href="#"
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon"
                    aria-hidden="true" class="-ml-1 mr-3 size-6 shrink-0 text-gray-400 group-hover:text-gray-500">
                    <path
